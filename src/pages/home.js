        ...
        <React.Fragment>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center px-4 py-12 bg-gradient-to-r from-orange-100 to-yellow-100">
                ...
                <div className="flex-1 pl-4 md:pl-8 text-center">
                    <h1 className="text-4xl font-extrabold text-orange-600 mb-4">Farm to Fork</h1>
                    <p className="text-lg font-bold text-gray-700 mb-4">
                        Discover Our Wide Range of Wholesome Food Products
                    </p>
                    <p className="text-gray-500 mb-6">Ready to Eat | Ready to Cook</p>

                    <button onClick={() => { navigate("/products") }} className="bg-white text-orange-500 text-lg md:text-xl font-semibold py-3 px-8 rounded-full hover:bg-orange-200 transition duration-300">
                        Explore Products
                    </button>
                </div>
            </div>
