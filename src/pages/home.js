        ...
        <React.Fragment>
            ...
            <div className="py-10 md:py-12 bg-gradient-to-br from-orange-50 to-yellow-100">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <button onClick={() => { navigate("/about") }} className="bg-white text-orange-500 text-base md:text-lg font-semibold py-3 px-8 rounded-full hover:bg-green-600 hover:text-white transition duration-300">
                        Read More
                    </button>
                </div>
            </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-12 mx-auto max-w-screen-lg">
                    ...
                    <div className="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <p className="text-xl md:text-2xl font-bold text-gray-700 mb-4">
                            Discover Our Wide Range of <br />Wholesome Food Products
                        </p>
